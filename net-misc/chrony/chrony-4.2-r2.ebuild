...
LICENSE="GPL-2"
SLOT="0"
IUSE="+cmdmon debug html ipv6 libedit libtomcrypt +nettle nss +ntp +nts +phc pps +refclock +rtc samba +seccomp +sechash selinux"
...
src_install() {
	...
	newinitd "${FILESDIR}"/chronyd.init-r3 chronyd
